...
notificationsRouter.post('/tokens', requireAuth, asyncHandler(async (req, res) => {
...
notificationsRouter.post('/reminders', requireAuth, requireRole(Role.PATIENT), asyncHandler(async (req, res) => {
...
notificationsRouter.get('/reminders', requireAuth, asyncHandler(async (req, res) => {
    const authUser = req.authUser;
    if (!authUser) {
        throw createError(401, 'Unauthorized');
    }
...
notificationsRouter.post('/dispatch', requireAuth, requireRole(Role.ADMIN), asyncHandler(async (_req, res) => {
