...
usersRouter.patch('/:id', requireAuth, requireRole(Role.ADMIN), asyncHandler(async (req, res) => {
...
usersRouter.get('/', requireAuth, requireRole(Role.ADMIN), asyncHandler(async (_req, res) => {
