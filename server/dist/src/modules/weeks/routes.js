...
weeksRouter.get('/', requireAuth, asyncHandler(async (_req, res) => {
...
weeksRouter.patch('/lessons/:lessonId', requireAuth, requireRole(Role.ADMIN), asyncHandler(async (req, res) => {
