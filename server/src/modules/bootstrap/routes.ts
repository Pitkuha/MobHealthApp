...
bootstrapRouter.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    let messages = [] as Awaited<ReturnType<typeof prisma.chatMessage.findMany>>;
    let links = [] as Awaited<ReturnType<typeof prisma.doctorPatientLink.findMany>>;
    let referralCodes = [] as Awaited<ReturnType<typeof prisma.referralCode.findMany>>;
